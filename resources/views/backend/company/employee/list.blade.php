            ...
            <div class="row align-items-md-center">
                <div class="col-md-6">
                    <div class="media m-v-10">
                        ...
                        <div class="media-body m-{{$alignShortRev}}-15">
                            <h6 class="mb-0">All Members ({{count($company->emp)}})</h6>
                ...
                <div class="col-md-6">
                    <div class="text-md-{{$alignreverse}} m-v-10">
                        ...
                        <a href="{{route('backend.company.employees',['id'=>$company->id,'q'=>'create'])}}" class="btn btn-primary m-{{$alignShortRev}}-15">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($company->emp as $emp)
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="avatar avatar-image">
                                                                <img src="{{asset($emp->user->profile_image)}}" alt="">
                                                            </div>
                                                            <div class="media-body m-{{$alignShortRev}}-15">
                                                    ...
                                                    <td class="text-right">
                                                        @include('backend.components.delete',[
                                                            'data' => $emp->id, 
                                                            'route' =>route('backend.company.deleteEmployee',['id'=>$company->id,'emp_id'=>$emp->id]), 
                                                        ])
                                                        <a href="{{route('backend.company.updateEmployee',['id'=>$company->id,'emp_id'=>$emp->id])}}" class="btn btn-success btn-tone">
